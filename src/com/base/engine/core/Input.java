...
public class Input {
	...
	/** Returns true while the key with the value of the keyCode is hold down*/
	public static boolean getKey(int keyCode){
		return Keyboard.isKeyDown(keyCode);
	}
	
	/** Returns true once, if the key with the value of the keyCode is pressed*/
